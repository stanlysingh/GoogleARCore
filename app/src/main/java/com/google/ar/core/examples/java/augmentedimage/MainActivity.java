...
import com.google.ar.core.examples.java.augmentedimage.sceneform.AugmentedVideoNode;
        ...
        for (AugmentedImage augmentedImage : updatedAugmentedImages) {
            if (augmentedImage.getTrackingState() == TrackingState.TRACKING) {
                ...
                if (augmentedImage.getName().equals("delorean")) {
                    ...
                    if (getIntent().getIntExtra("call",2)==1){
                        AugmentedVideoNode node = new AugmentedVideoNode(this,augmentedImage,arSceneView);
